...
export function NewNoteCard( { onNoteCreated }: newNoteCardProps) {
  ...
  function handleStopRecording() {
    ...
    return(
      <Dialog.Root>
        <Dialog.Trigger className="rounded-md outline-none flex flex-col text-left bg-slate-700 p-5 gap-3 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
                  ...
                  <form className="flex-1 flex flex-col ">
                      ...
                      {isRecording ? (
                        <button 
                          ...
                          className="w-full flex items-start justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300 outline-none font-medium hover:text-slate-100"                          >
